...
public class AlfredTest {
    ...
    */
    public static void main(String[] args) {
        ...
        String testGreetingPeriodo = alfredBot.guessGreeting("Maria", "Buenas tardes");
        String testGreetingPeriodoF = alfredBot.guessGreeting("Maria", new Date());
        ...
        System.out.println(testGreetingPeriodoF);

        System.out.println(testGreetingPeriodo);
